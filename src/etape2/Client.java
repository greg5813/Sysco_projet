...
///////////////////////////////////////////////////
	...
	public static SharedObject lookup(String name) {
		...
		try {
			Integer id = s.lookup(name);
                        System.out.println("lookup id object "+id);
			if (id != 0) {
	...
	public static void register(String name, SharedObject_itf so) {
		try {
			...
			int id = o.id;
			s.register(name,id);
                        System.out.println("register id object "+id);
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
////////////////////////////////////////////////////////////
	...
	public Object reduce_lock(int id) throws java.rmi.RemoteException { //////////////////por que este no es estatico???
